...
func (uc *UserCreate) AddOrganisationIDs(ids ...int) *UserCreate {
	uc.mutation.AddOrganisationIDs(ids...)
	return uc
}

// AddOrganisations adds the "organisations" edges to the Organisation entity.
func (uc *UserCreate) AddOrganisations(o ...*Organisation) *UserCreate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return uc.AddOrganisationIDs(ids...)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.OrganisationsIDs(); len(nodes) > 0 {
