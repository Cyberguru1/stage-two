...
func (m *OrganisationMutation) SetOrgid(u uuid.UUID) {
	m.orgid = &u
}

// Orgid returns the value of the "orgid" field in the mutation.
func (m *OrganisationMutation) Orgid() (r uuid.UUID, exists bool) {
	v := m.orgid
	if v == nil {
		return
	}
...
// OldOrgid returns the old "orgid" field's value of the Organisation entity.
// If the Organisation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *OrganisationMutation) OldOrgid(ctx context.Context) (v uuid.UUID, err error) {
...
// ResetOrgid resets all changes to the "orgid" field.
func (m *OrganisationMutation) ResetOrgid() {
	m.orgid = nil
}
...
func (m *OrganisationMutation) SetDescription(s string) {
	m.description = &s
}

// Description returns the value of the "description" field in the mutation.
func (m *OrganisationMutation) Description() (r string, exists bool) {
	v := m.description
	if v == nil {
		return
	}
...
// OldDescription returns the old "description" field's value of the Organisation entity.
// If the Organisation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *OrganisationMutation) OldDescription(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *OrganisationMutation) ClearDescription() {
	m.description = nil
	m.clearedFields[organisation.FieldDescription] = struct{}{}
}

// DescriptionCleared returns if the "description" field was cleared in this mutation.
func (m *OrganisationMutation) DescriptionCleared() bool {
	_, ok := m.clearedFields[organisation.FieldDescription]
	return ok
}

// ResetDescription resets all changes to the "description" field.
func (m *OrganisationMutation) ResetDescription() {
	m.description = nil
...
func (m *OrganisationMutation) Fields() []string {
	...
	if m.orgid != nil {
		fields = append(fields, organisation.FieldOrgid)
	}
	if m.name != nil {
		fields = append(fields, organisation.FieldName)
	}
	if m.description != nil {
		fields = append(fields, organisation.FieldDescription)
	}
	return fields
}
...
func (m *OrganisationMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(organisation.FieldDescription) {
		fields = append(fields, organisation.FieldDescription)
	}
	return fields
}
...
type UserMutation struct {
	...
	phone                *string
	clearedFields        map[string]struct{}
	organisations        map[int]struct{}
	removedorganisations map[int]struct{}
	clearedorganisations bool
	done                 bool
...
func (m *UserMutation) AddOrganisationIDs(ids ...int) {
	if m.organisations == nil {
		m.organisations = make(map[int]struct{})
	}
	for i := range ids {
		m.organisations[ids[i]] = struct{}{}
	}
}

// ClearOrganisations clears the "organisations" edge to the Organisation entity.
func (m *UserMutation) ClearOrganisations() {
	m.clearedorganisations = true
}

// OrganisationsCleared reports if the "organisations" edge to the Organisation entity was cleared.
func (m *UserMutation) OrganisationsCleared() bool {
	return m.clearedorganisations
}

// RemoveOrganisationIDs removes the "organisations" edge to the Organisation entity by IDs.
func (m *UserMutation) RemoveOrganisationIDs(ids ...int) {
	if m.removedorganisations == nil {
		m.removedorganisations = make(map[int]struct{})
	}
	for i := range ids {
		delete(m.organisations, ids[i])
		m.removedorganisations[ids[i]] = struct{}{}
	}
}

// RemovedOrganisations returns the removed IDs of the "organisations" edge to the Organisation entity.
func (m *UserMutation) RemovedOrganisationsIDs() (ids []int) {
	for id := range m.removedorganisations {
		ids = append(ids, id)
	}
	return
}

// OrganisationsIDs returns the "organisations" edge IDs in the mutation.
func (m *UserMutation) OrganisationsIDs() (ids []int) {
	for id := range m.organisations {
		ids = append(ids, id)
	}
	return
}

// ResetOrganisations resets all changes to the "organisations" edge.
func (m *UserMutation) ResetOrganisations() {
	m.organisations = nil
	m.clearedorganisations = false
	m.removedorganisations = nil
}
...
func (m *UserMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.organisations != nil {
		edges = append(edges, user.EdgeOrganisations)
	}
	return edges
}
...
func (m *UserMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case user.EdgeOrganisations:
		ids := make([]ent.Value, 0, len(m.organisations))
		for id := range m.organisations {
			ids = append(ids, id)
		}
		return ids
...
func (m *UserMutation) RemovedIDs(name string) []ent.Value {
	switch name {
	case user.EdgeOrganisations:
		ids := make([]ent.Value, 0, len(m.removedorganisations))
		for id := range m.removedorganisations {
			ids = append(ids, id)
		}
		return ids
